...
export default function AgentID({
  ...
  const clearanceLevelNum = clearanceLevel
    ? CLEARANCE_LEVELS[clearanceLevel] || 1
    : 1;
  ...
  useEffect(() => {
    const download = async () => {
      try {
        ...
        //   }
        // })
        const overlay = clonedElement.querySelector(
          "#loading-overlay, #loading-overlay-mobile",
        );
        overlay?.remove();
        ...
        <div className="relative w-fit pt-12">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div className="relative" ref={cardRef}>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                <div
                  ...
                  style={{ border: "5px solid #1A1A1A", borderRadius: "24px" }}
                >
                  ...
                  <div style={{ zIndex: 2, position: "relative" }}>
                    ...
                    >
                      CODE NAME:{" "}
                      <span style={{ fontWeight: 700 }}>{codename}</span>
                    </p>
                    <p
                      style={{
                        fontFamily: "'Courier Prime', monospace",
              ...
              {isDownloading && (
                <div
                  id="loading-overlay"
                  className="absolute inset-0 flex items-center justify-center bg-[#FDF5E6]/80"
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="mt-3 flex justify-center gap-1">
                      <span
                        className="w-2 h-2 bg-[#1A1A1A] rounded-full animate-bounce"
            ...
            <div className="w-full flex justify-center">
              ...
              >
                Show this card to verify your <br /> clearance with fellow field
                agents
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-between items-center w-full h-full p-4">
            ...
            <div className="w-full flex justify-start pl-2 pt-2">
              <p
                className="text-xs font-courier italic text-[#FDFDFD] bg-[#1A1A1A] px-2 py-1"
            ...
            <div className="flex flex-col items-center gap-3 flex-1 justify-center">
              <div
                className="relative"
                ref={mobileCardRef}
                style={{ width: "300px", height: "210px", overflow: "hidden" }}
              >
                <Image
                  src="/images/idimage.png"
                  alt="id image"
                ...
                {/* Bordered content area: text + specialist image */}
                <div
                  className="absolute inset-0 flex flex-col items-center justify-center px-2 py-2"
                  style={{ gap: "6px", width: "100%", height: "100%" }}
                >
                  <div
