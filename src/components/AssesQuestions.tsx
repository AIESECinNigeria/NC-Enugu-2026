...
export default function AssesQuestions() {
        ...
        <div className={`${styles.container2} flex flex-col py-[50px] px-[50px] items-center relative `}>
            <div className={`${styles.quest1}  w-[1200px] h-auto flex flex-col items-center relative `}>
                ...
                <div className={`${styles.paperTwo} w-full h-[700px]`}>
                    <p className='bg-[#1A1A1A] w-[520px] mt-[38px] ml-[147px] p-[5px] text-white font-courier text-[20px] '>CREW ASSESSMENT / CLASSIFICATION PROTOCOL</p>
                    <div className='mt-[20px] ml-[177px] text-[#1A1A1A] text-[19px] font-courier italic max-w-[700px] '>Every operative has a role. This assessment determines yours. Answer honestly. The operation depends on it.</div>
                    <form className='self-center flex flex-col items-center w-[900px] ' onSubmit={handleSubmit}>
                        <h2 className="text-[#1A1A1A] w-[800px] text-[24px] text-left mt-[20px] ml-[30px] font-courier font-bold ">{activeQuestion.question}</h2>
                        ...
                        {activeQuestion.options.map((option) => {
                            ...
                            <div key={option.value}>
                                ...
                                className="block text-left text-[#1a1a1a] w-[760px] text-[28px] p-2 border border-[#1a1a1a] font-tungstenC cursor-pointer transition-all
                                    hover:bg-black
                                    hover:text-white
                        ...
                        ) : <Link href="/components/Hero.tsx" className="flex items-center px-4 py-2 border-[1px] text-black hover:bg-black hover:text-white ">
                            <MdArrowBackIosNew />
                            </Link>
                        }
